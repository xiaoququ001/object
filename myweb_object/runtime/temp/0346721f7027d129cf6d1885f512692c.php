<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\wamp\www\object\myweb_object\public/../application/admin\view\login\index.html";i:1517411174;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
  <meta charset="utf-8">
    ...
    <form class="form form-horizontal" action="<?php echo url('login/check'); ?>" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="/captcha" alt="请点击验证码" onclick="this.src='/captcha?id=math.random();'" width="150px" height="40px">
          </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
